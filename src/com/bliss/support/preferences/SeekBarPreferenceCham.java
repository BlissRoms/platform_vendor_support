...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String BLISSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, BLISSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, BLISSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(BLISSNS, "interval");
            if(newInterval != null)
